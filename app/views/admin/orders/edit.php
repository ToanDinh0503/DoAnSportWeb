                                ...
                                <div class="form-section">
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="trang_thai">
                                            <option value="pending" <?= $order['trang_thai'] === 'pending' ? 'selected' : '' ?>>Chờ xử lý</option>
                                            <option value="processing" <?= $order['trang_thai'] === 'processing' ? 'selected' : '' ?>>Đang giao</option>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select class="form-select" name="payment_method">
                                            <option value="COD" <?= $order['payment_method'] === 'COD' ? 'selected' : '' ?>>COD (khi nhận)</option>
